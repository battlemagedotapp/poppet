...
function AlertDialogOverlay({
	...
	return (
		<AlertDialogPrimitive.Overlay
			...
			className={cn(
				"data-open:animate-in data-open:fade-in-0 data-closed:animate-out data-closed:fade-out-0 bg-foreground/15 fixed inset-0 z-50 duration-100 supports-backdrop-filter:backdrop-blur-xs",
				className
			)}
			{...props}
		/>
